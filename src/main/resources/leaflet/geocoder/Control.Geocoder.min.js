...
this.L.Control.Geocoder=function(b){function r(a){return t[a]}function u(a){if(null==a)return"";if(!a)return a+"";a=""+a;return v.test(a)?a.replace(w,r):a}function p(a,c,e,d,f){var k="_l_geocoder_"+x++;c[f||"callback"]=k;window[k]=b.Util.bind(e,d);e=document.createElement("script");e.type="text/javascript";e.src=a+b.Util.getParamString(c);e.id=k;document.getElementsByTagName("head")[0].appendChild(e)}function l(a,c,e){var d=new XMLHttpRequest;d.onreadystatechange=function(){4===d.readyState&&(200!==
d.status&&304!==d.status?e(""):e(JSON.parse(d.response)))};d.open("GET",a+b.Util.getParamString(c),!0);d.setRequestHeader("Accept","application/json");d.send(null)}function y(a,b){return a.replace(/\{ *([\w_]+) *\}/g,function(a,c){a=b[c];void 0===a?a="":"function"===typeof a&&(a=a(b));return u(a)})}b=b&&b.hasOwnProperty("default")?b["default"]:b;var x=0,w=/[&<>"'`]/g,v=/[&<>"'`]/,t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},q=b.Class.extend({options:{serviceUrl:"https://nominatim.openstreetmap.org/",
...
a)},geocode:function(a,c,e){l(this.options.serviceUrl+"search",b.extend({q:a,limit:5,format:"json",addressdetails:1},this.options.geocodingQueryParams),b.bind(function(a){for(var f=[],d=a.length-1;0<=d;d--){for(var h=a[d].boundingbox,g=0;4>g;g++)h[g]=parseFloat(h[g]);f[d]={icon:a[d].icon,name:a[d].display_name,html:this.options.htmlTemplate?this.options.htmlTemplate(a[d]):void 0,bbox:b.latLngBounds([h[0],h[2]],[h[1],h[3]]),center:b.latLng(a[d].lat,a[d].lon),properties:a[d]}}c.call(e,f)},this))},reverse:function(a,
c,e,d){l(this.options.serviceUrl+"reverse",b.extend({lat:a.lat,lon:a.lng,zoom:Math.round(Math.log(c/256)/Math.log(2)),addressdetails:1,format:"json"},this.options.reverseQueryParams),b.bind(function(a){var c=[];if(a&&a.lat&&a.lon){var f=b.latLng(a.lat,a.lon);c.push({name:a.display_name,html:this.options.htmlTemplate?this.options.htmlTemplate(a):void 0,center:f,bounds:b.latLngBounds(f,f),properties:a})}e.call(d,c)},this))}}),n=b.Control.extend({options:{showResultIcons:!1,collapsed:!0,expand:"touch",
...
_createAlt:function(a,c){var e=b.DomUtil.create("li",""),d=b.DomUtil.create("a","",e),f=this.options.showResultIcons&&a.icon?b.DomUtil.create("img","",d):null,k=a.html?void 0:document.createTextNode(a.name);f&&(f.src=a.icon);e.setAttribute("data-result-index",c);a.html?d.innerHTML+=a.html:d.appendChild(k);b.DomEvent.addListener(e,"mousedown touchstart",function(c){this._preventBlurCollapse=!0;b.DomEvent.stop(c);this._geocodeResultSelected(a);b.DomEvent.on(e,"click",function(){this.options.collapsed?
...
a},geocode:function(a,c,e){p("https://dev.virtualearth.net/REST/v1/Locations",{query:a,key:this.key},function(a){var d=[];if(0<a.resourceSets.length)for(var k=a.resourceSets[0].resources.length-1;0<=k;k--){var h=a.resourceSets[0].resources[k],g=h.bbox;d[k]={name:h.name,bbox:b.latLngBounds([g[0],g[1]],[g[2],g[3]]),center:b.latLng(h.point.coordinates)}}c.call(e,d)},this,"jsonp")},reverse:function(a,c,e,d){p("//dev.virtualearth.net/REST/v1/Locations/"+a.lat+","+a.lng,{key:this.key},function(a){for(var c=
...
geocode:function(a,c,e){l(this.options.serviceUrl+"/address",{key:this._key,location:a,limit:5,outFormat:"json"},b.bind(function(a){var d=[];if(a.results&&a.results[0].locations)for(var k=a.results[0].locations.length-1;0<=k;k--){var h=a.results[0].locations[k];var g=b.latLng(h.latLng);d[k]={name:this._formatName(h.street,h.adminArea4,h.adminArea3,h.adminArea1),bbox:b.latLngBounds(g,g),center:g}}c.call(e,d)},this))},reverse:function(a,c,e,d){l(this.options.serviceUrl+"/reverse",{key:this._key,location:a.lat+
...
c){b.setOptions(this,c);this.options.geocodingQueryParams.access_token=a;this.options.reverseQueryParams.access_token=a},geocode:function(a,c,e){var d=this.options.geocodingQueryParams;"undefined"!==typeof d.proximity&&d.proximity.hasOwnProperty("lat")&&d.proximity.hasOwnProperty("lng")&&(d.proximity=d.proximity.lng+","+d.proximity.lat);l(this.options.serviceUrl+encodeURIComponent(a)+".json",d,function(a){var d=[];if(a.features&&a.features.length)for(var f=0;f<=a.features.length-1;f++){var g=a.features[f];
var m=b.latLng(g.center.reverse());var l=g.hasOwnProperty("bbox")?b.latLngBounds(b.latLng(g.bbox.slice(0,2).reverse()),b.latLng(g.bbox.slice(2,4).reverse())):b.latLngBounds(m,m);d[f]={name:g.place_name,bbox:l,center:m}}c.call(e,d)})},suggest:function(a,b,e){return this.geocode(a,b,e)},reverse:function(a,c,e,d){l(this.options.serviceUrl+encodeURIComponent(a.lng)+","+encodeURIComponent(a.lat)+".json",this.options.reverseQueryParams,function(a){var c=[];if(a.features&&a.features.length)for(var f=0;f<=
a.features.length-1;f++){var g=a.features[f];var m=b.latLng(g.center.reverse());var l=g.hasOwnProperty("bbox")?b.latLngBounds(b.latLng(g.bbox.slice(0,2).reverse()),b.latLng(g.bbox.slice(2,4).reverse())):b.latLngBounds(m,m);c[f]={name:g.place_name,bbox:l,center:m}}e.call(d,c)})}}),C=b.Class.extend({options:{serviceUrl:"https://api.what3words.com/v2/"},initialize:function(a){this._accessToken=a},geocode:function(a,c,e){l(this.options.serviceUrl+"forward",{key:this._accessToken,addr:a.split(/\s+/).join(".")},
function(a){var d=[];if(a.hasOwnProperty("geometry")){var k=b.latLng(a.geometry.lat,a.geometry.lng);var h=b.latLngBounds(k,k);d[0]={name:a.words,bbox:h,center:k}}c.call(e,d)})},suggest:function(a,b,e){return this.geocode(a,b,e)},reverse:function(a,c,e,d){l(this.options.serviceUrl+"reverse",{key:this._accessToken,coords:[a.lat,a.lng].join()},function(a){var c=[];if(200==a.status.status){var f=b.latLng(a.geometry.lat,a.geometry.lng);var g=b.latLngBounds(f,f);c[0]={name:a.words,bbox:g,center:f}}e.call(d,
c)})}}),D=b.Class.extend({options:{serviceUrl:"https://maps.googleapis.com/maps/api/geocode/json",geocodingQueryParams:{},reverseQueryParams:{}},initialize:function(a,c){this._key=a;b.setOptions(this,c);this.options.serviceUrl=this.options.service_url||this.options.serviceUrl},geocode:function(a,c,e){a={address:a};this._key&&this._key.length&&(a.key=this._key);a=b.Util.extend(a,this.options.geocodingQueryParams);l(this.options.serviceUrl,a,function(a){var d=[];if(a.results&&a.results.length)for(var k=
0;k<=a.results.length-1;k++){var h=a.results[k];var g=b.latLng(h.geometry.location);var m=b.latLngBounds(b.latLng(h.geometry.viewport.northeast),b.latLng(h.geometry.viewport.southwest));d[k]={name:h.formatted_address,bbox:m,center:g,properties:h.address_components}}c.call(e,d)})},reverse:function(a,c,e,d){a={latlng:encodeURIComponent(a.lat)+","+encodeURIComponent(a.lng)};a=b.Util.extend(a,this.options.reverseQueryParams);this._key&&this._key.length&&(a.key=this._key);l(this.options.serviceUrl,a,function(a){var c=
[];if(a.results&&a.results.length)for(var f=0;f<=a.results.length-1;f++){var g=a.results[f];var m=b.latLng(g.geometry.location);var l=b.latLngBounds(b.latLng(g.geometry.viewport.northeast),b.latLng(g.geometry.viewport.southwest));c[f]={name:g.formatted_address,bbox:l,center:m,properties:g.address_components}}e.call(d,c)})}}),E=b.Class.extend({options:{serviceUrl:"https://photon.komoot.de/api/",reverseUrl:"https://photon.komoot.de/reverse/",nameProperties:"name street suburb hamlet town city state country".split(" ")},
initialize:function(a){b.setOptions(this,a)},geocode:function(a,c,e){a=b.extend({q:a},this.options.geocodingQueryParams);l(this.options.serviceUrl,a,b.bind(function(a){c.call(e,this._decodeFeatures(a))},this))},suggest:function(a,b,e){return this.geocode(a,b,e)},reverse:function(a,c,e,d){a=b.extend({lat:a.lat,lon:a.lng},this.options.reverseQueryParams);l(this.options.reverseUrl,a,b.bind(function(a){e.call(d,this._decodeFeatures(a))},this))},_decodeFeatures:function(a){var c=[],e;if(a&&a.features)for(e=
0;e<a.features.length;e++){var d=a.features[e];var f=d.geometry.coordinates;f=b.latLng(f[1],f[0]);var k=(k=d.properties.extent)?b.latLngBounds([k[1],k[0]],[k[3],k[2]]):b.latLngBounds(f,f);c.push({name:this._deocodeFeatureName(d),html:this.options.htmlTemplate?this.options.htmlTemplate(d):void 0,center:f,bbox:k,properties:d.properties})}return c},_deocodeFeatureName:function(a){var b;for(b=0;!e&&b<this.options.nameProperties.length;b++)var e=a.properties[this.options.nameProperties[b]];return e}}),
F=b.Class.extend({options:{serviceUrl:"https://search.mapzen.com/v1",geocodingQueryParams:{},reverseQueryParams:{}},initialize:function(a,c){b.Util.setOptions(this,c);this._apiKey=a;this._lastSuggest=0},geocode:function(a,c,e){var d=this;l(this.options.serviceUrl+"/search",b.extend({api_key:this._apiKey,text:a},this.options.geocodingQueryParams),function(a){c.call(e,d._parseResults(a,"bbox"))})},suggest:function(a,c,e){var d=this;l(this.options.serviceUrl+"/autocomplete",b.extend({api_key:this._apiKey,
text:a},this.options.geocodingQueryParams),b.bind(function(a){a.geocoding.timestamp>this._lastSuggest&&(this._lastSuggest=a.geocoding.timestamp,c.call(e,d._parseResults(a,"bbox")))},this))},reverse:function(a,c,e,d){var f=this;l(this.options.serviceUrl+"/reverse",b.extend({api_key:this._apiKey,"point.lat":a.lat,"point.lon":a.lng},this.options.reverseQueryParams),function(a){e.call(d,f._parseResults(a,"bounds"))})},_parseResults:function(a,c){var e=[];b.geoJson(a,{pointToLayer:function(a,c){return b.circleMarker(c)},
onEachFeature:function(a,f){a={};if(f.getBounds){var d=f.getBounds();var h=d.getCenter()}else h=f.getLatLng(),d=b.latLngBounds(h,h);a.name=f.feature.properties.label;a.center=h;a[c]=d;a.properties=f.feature.properties;e.push(a)}});return e}}),G=b.Class.extend({options:{service_url:"http://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer"},initialize:function(a,c){b.setOptions(this,c);this._accessToken=a},geocode:function(a,c,e){a={SingleLine:a,outFields:"Addr_Type",forStorage:!1,maxLocations:10,
f:"json"};this._key&&this._key.length&&(a.token=this._key);l(this.options.service_url+"/findAddressCandidates",a,function(a){var d=[];if(a.candidates&&a.candidates.length)for(var k=0;k<=a.candidates.length-1;k++){var h=a.candidates[k];var g=b.latLng(h.location.y,h.location.x);var l=b.latLngBounds(b.latLng(h.extent.ymax,h.extent.xmax),b.latLng(h.extent.ymin,h.extent.xmin));d[k]={name:h.address,bbox:l,center:g}}c.call(e,d)})},suggest:function(a,b,e){return this.geocode(a,b,e)},reverse:function(a,c,
e,d){a={location:encodeURIComponent(a.lng)+","+encodeURIComponent(a.lat),distance:100,f:"json"};l(this.options.service_url+"/reverseGeocode",a,function(a){var c=[];if(a&&!a.error){var f=b.latLng(a.location.y,a.location.x);c.push({name:a.address.Match_addr,center:f,bounds:b.latLngBounds(f,f)})}e.call(d,c)})}}),H=b.Class.extend({options:{geocodeUrl:"http://geocoder.api.here.com/6.2/geocode.json",reverseGeocodeUrl:"http://reverse.geocoder.api.here.com/6.2/reversegeocode.json",app_id:"<insert your app_id here>",
