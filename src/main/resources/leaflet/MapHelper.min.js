...
function addMouseOverToLayer(a){var b=window[a];b.on("mouseover",function(c){c=c.target.getLatLng();jscallback.registerWaypoint(a,c.lat,c.lng)});b.on("mouseout",function(c){c=c.target.getLatLng();jscallback.deregisterWaypoint(a,c.lat,c.lng)})};
