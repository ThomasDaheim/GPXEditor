...
c.length&&(c+="\n"),c+=b.tags.website,a.properties.Website=b.tags.website),b.tags.hasOwnProperty("description")&&(0<c.length&&(c+="\n"),c+=b.tags.description,a.properties.Description=b.tags.description));return c}function initCallback(a,b,c,e){addMouseOverToLayer(a);-1!==b&&-1!==c&&(addClickToLayer(a,b,c),makeDraggable(a,b,c,e))}
