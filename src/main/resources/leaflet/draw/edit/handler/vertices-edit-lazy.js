/**
 * https://gist.github.com/doubotis/dc8c32451bb2356b9b1e8e2b95e195d4
 */
L.Edit.PolyVerticesEdit.include({
    addHooks: function () {
        ...
        if (this._poly._map) {
            ...
            // TFE, 20200510: too stupid to pass option...
            // if we include it, we want it :-)
            this.options.lazyMode = true;
