...
a/=1E3;a=(a-Math.floor(a)).toFixed(2).slice(1);10>e&&(e="0"+e);10>c&&(c="0"+c);return b+":"+e+":"+c+a},ParseGPX:function(a){var c={type:"Feature",geometry:{type:"MultiPoint",coordinates:[]},properties:{time:[],speed:[],altitude:[]},bbox:[]};a=$.parseXML(a);a=$(a).find("trkpt");for(var b=0,e=a.length;b<e;b++){var g=a[b],h=parseFloat(g.getAttribute("lat")),k=parseFloat(g.getAttribute("lon")),l=$(g).find("time").text();g=$(g).find("ele").text();l=(new Date(l)).getTime();g=parseFloat(g);var f=c.properties.time,
n=c.properties.altitude;c.geometry.coordinates.push([h,k]);f.push(l);n.push(g)}return c}}});b.Playback=b.Playback||{};b.Playback.MoveableMarker=b.Marker.extend({initialize:function(a,c,d){var e=c.marker||{};jQuery.isFunction(e)&&(e=e(d));b.Marker.prototype.initialize.call(this,a,e);this.popupContent="";this.feature=d;e.getPopup&&(this.popupContent=e.getPopup(d));c.popups&&this.bindPopup(this.getPopupContent()+a.toString());c.labels&&(this.bindLabel?this.bindLabel(this.getPopupContent()):console.log("Label binding requires leaflet-label (https://github.com/Leaflet/Leaflet.label)"))},
getPopupContent:function(){return""!==this.popupContent?"<b>"+this.popupContent+"</b><br/>":""},move:function(a,c){b.DomUtil.TRANSITION&&(this._icon&&(this._icon.style[b.DomUtil.TRANSITION]="all "+c+"ms linear",this._popup&&this._popup._wrapper&&(this._popup._wrapper.style[b.DomUtil.TRANSITION]="all "+c+"ms linear")),this._shadow&&(this._shadow.style[b.DomUtil.TRANSITION]="all "+c+"ms linear"));this.setLatLng(a);this._popup&&this._popup.setContent(this.getPopupContent()+this._latlng.toString())},
_old__setPos:b.Marker.prototype._setPos,_updateImg:function(a,c,d){c=b.point(d).divideBy(2)._subtract(b.point(c));d=" translate("+-c.x+"px, "+-c.y+"px)";d+=" rotate("+this.options.iconAngle+"deg)";d+=" translate("+c.x+"px, "+c.y+"px)";a.style[b.DomUtil.TRANSFORM]+=d},setIconAngle:function(a){this.options.iconAngle=a;this._map&&this.update()},_setPos:function(a){this._icon&&(this._icon.style[b.DomUtil.TRANSFORM]="");this._shadow&&(this._shadow.style[b.DomUtil.TRANSFORM]="");this._old__setPos.apply(this,
[a]);if(this.options.iconAngle){a=this.options.icon.options.iconAnchor;var c=this.options.icon.options.iconSize;if(this._icon){var d=this._icon;this._updateImg(d,a,c)}this._shadow&&(c=this.options.icon.options.shadowSize,d=this._shadow,this._updateImg(d,a,c))}}});b.Playback=b.Playback||{};b.Playback.Track=b.Class.extend({initialize:function(a,c){c=c||{};var b=c.tickLen||250;this._staleTime=c.staleTime||36E5;this._fadeMarkersWhenStale=c.fadeMarkersWhenStale||!1;this._geoJSON=a;this._tickLen=b;this._ticks=
[];this._marker=null;this._orientations=[];var e=a.properties.time;this._orientIcon=c.orientIcons;var g=a.geometry.coordinates,h=g[0],k=g[1],l=e[0],f=l,n=e[1],m=f%b;if(1===e.length)0!==m&&(f+=b-m),this._ticks[f]=g[0],this._orientations[f]=0,this._endTime=this._startTime=f;else{0!==m?(m=b-m,f+=m,this._ticks[f]=this._interpolatePoint(h,k,m/(n-l))):this._ticks[f]=h;this._orientations[f]=this._directionOfPoint(h,k);a=this._orientations[f];this._startTime=f;for(f+=b;f<n;){var q=(f-l)/(n-l);this._ticks[f]=
this._interpolatePoint(h,k,q);this._orientations[f]=this._directionOfPoint(h,k);a=this._orientations[f];f+=b}for(var p=1,r=g.length;p<r;p++)for(h=g[p],k=g[p+1],f=l=e[p],n=e[p+1],m=f%b,0!==m&&n?(m=b-m,q=m/(n-l),f+=m,this._ticks[f]=this._interpolatePoint(h,k,q)):this._ticks[f]=h,k?(this._orientations[f]=this._directionOfPoint(h,k),a=this._orientations[f]):this._orientations[f]=a,f+=b;f<n;)q=(f-l)/(n-l),this._ticks[f]=n-l>c.maxInterpolationTime?h:this._interpolatePoint(h,k,q),k?(this._orientations[f]=
this._directionOfPoint(h,k),a=this._orientations[f]):this._orientations[f]=a,f+=b;this._endTime=f-b;this._lastTick=this._ticks[this._endTime]}},_interpolatePoint:function(a,c,b){try{var d=[c[0]-a[0],c[1]-a[1]],g=[d[0]*b,d[1]*b];return[a[0]+g[0],a[1]+g[1]]}catch(h){console.log("err: cant interpolate a point"),console.log(["start",a]),console.log(["end",c]),console.log(["ratio",b])}},_directionOfPoint:function(a,c){return this._orientIcon?this._getBearing(a[1],a[0],c[1],c[0]):0},_getBearing:function(a,
c,b,e){a=this._radians(a);c=this._radians(c);b=this._radians(b);e=this._radians(e);c=e-c;a=Math.log(Math.tan(b/2+Math.PI/4)/Math.tan(a/2+Math.PI/4));Math.abs(c)>Math.PI&&(c=0<c?-(2*Math.PI-c):2*Math.PI+c);return(this._degrees(Math.atan2(c,a))+360)%360},_radians:function(a){return Math.PI/180*a},_degrees:function(a){return 180/Math.PI*a},getFirstTick:function(){return this._ticks[this._startTime]},getLastTick:function(){return this._ticks[this._endTime]},getStartTime:function(){return this._startTime},
getEndTime:function(){return this._endTime},getTickMultiPoint:function(){for(var a=this.getStartTime(),c=this.getEndTime(),b=[],e=[];a<=c;)e.push(a),b.push(this.tick(a)),a+=this._tickLen;return{type:"Feature",geometry:{type:"MultiPoint",coordinates:b},properties:{time:e}}},trackPresentAtTick:function(a){return a>=this._startTime},trackStaleAtTick:function(a){return this._endTime+this._staleTime<=a},tick:function(a){a>this._endTime&&(a=this._endTime);a<this._startTime&&(a=this._startTime);return this._ticks[a]},
courseAtTime:function(a){a>this._endTime&&(a=this._endTime);a<this._startTime&&(a=this._startTime);return this._orientations[a]},setMarker:function(a,c){var d;if(d=a?this.tick(a):this.getFirstTick()){d=new b.LatLng(d[0],d[1]);this._marker=new b.Playback.MoveableMarker(d,c,this._geoJSON);if(c.mouseOverCallback)this._marker.on("mouseover",c.mouseOverCallback);if(c.clickCallback)this._marker.on("click",c.clickCallback);this._fadeMarkersWhenStale&&!this.trackPresentAtTick(a)&&this._marker.setOpacity(0)}return this._marker},
moveMarker:function(a,c,b){this._marker&&(this._fadeMarkersWhenStale&&(this.trackPresentAtTick(b)?this._marker.setOpacity(1):this._marker.setOpacity(0),this.trackStaleAtTick(b)&&this._marker.setOpacity(.25)),this._orientIcon&&this._marker.setIconAngle(this.courseAtTime(b)),this._marker.move(a,c))},getMarker:function(){return this._marker}});b.Playback=b.Playback||{};b.Playback.TrackController=b.Class.extend({initialize:function(a,b,d){this.options=d||{};this._map=a;this._tracks=[];this.setTracks(b)},
clearTracks:function(){for(;0<this._tracks.length;){var a=this._tracks.pop().getMarker();a&&this._map.removeLayer(a)}},setTracks:function(a){this.clearTracks();this.addTracks(a)},addTracks:function(a){if(a)if(a instanceof Array)for(var b=0,d=a.length;b<d;b++)this.addTrack(a[b]);else this.addTrack(a)},addTrack:function(a,b){a&&(b=a.setMarker(b,this.options))&&(b.addTo(this._map),this._tracks.push(a))},tock:function(a,c){for(var d=0,e=this._tracks.length;d<e;d++){var g=this._tracks[d].tick(a);g=new b.LatLng(g[0],
g[1]);this._tracks[d].moveMarker(g,c,a)}},getStartTime:function(){var a=0;if(0<this._tracks.length){a=this._tracks[0].getStartTime();for(var b=1,d=this._tracks.length;b<d;b++){var e=this._tracks[b].getStartTime();e<a&&(a=e)}}return a},getEndTime:function(){var a=0;if(0<this._tracks.length){a=this._tracks[0].getEndTime();for(var b=1,d=this._tracks.length;b<d;b++){var e=this._tracks[b].getEndTime();e>a&&(a=e)}}return a},getTracks:function(){return this._tracks}});b.Playback=b.Playback||{};b.Playback.Clock=
b.Class.extend({initialize:function(a,c,d,e){this._trackController=a;this._callbacksTimeChangeArray=[];c&&this.addCallbackTimeChange(c);this._callbacksEndPlaybackArray=[];d&&this.addCallbackEndPlayback(d);b.setOptions(this,e);this._speed=this.options.speed;this._tickLen=this.options.tickLen;this._cursor=this._trackController.getStartTime();this._transitionTime=this._tickLen/this._speed},_tick:function(a){a._cursor>a._trackController.getEndTime()?(window.clearInterval(a._intervalID),a._intervalID=
null,a._callbacksEndPlayback(a._cursor)):(a._trackController.tock(a._cursor,a._transitionTime),a._callbacksTimeChange(a._cursor),a._cursor+=a._tickLen)},_callbacksTimeChange:function(a){for(var b=this._callbacksTimeChangeArray,d=0,e=b.length;d<e;d++)b[d](a)},addCallbackTimeChange:function(a){this._callbacksTimeChangeArray.push(a)},_callbacksEndPlayback:function(a){for(var b=this._callbacksEndPlaybackArray,d=0,e=b.length;d<e;d++)b[d](a)},addCallbackEndPlayback:function(a){this._callbacksEndPlaybackArray.push(a)},
...
this.start())},setCursor:function(a){if(a=parseInt(a)){var b=a%this._tickLen;0!==b&&(a+=this._tickLen-b);this._cursor=a;this._trackController.tock(this._cursor,0);this._callbacksTimeChange(this._cursor)}},getTime:function(){return this._cursor},getStartTime:function(){return this._trackController.getStartTime()},getEndTime:function(){return this._trackController.getEndTime()},getTickLen:function(){return this._tickLen}});b.Playback=b.Playback||{};b.Playback.TracksLayer=b.Class.extend({initialize:function(a,
