...
b.getLatLngs();jscallback.updateRoute("editable:vertex:new",c,coordsToString(a))});b.on("editable:vertex:mouseover",function(a){a=a.latlng;jscallback.registerRoute(c,a.lat,a.lng);b.openTooltip(a)});b.on("editable:vertex:mouseout",function(a){a=a.latlng;jscallback.deregisterRoute(c,a.lat,a.lng);b.closeTooltip()})};