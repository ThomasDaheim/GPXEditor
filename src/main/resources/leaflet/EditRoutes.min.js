'use strict';myMap.editTools=new L.Editable(myMap,{editable:!0});var tooltip=document.createElement("div");tooltip.style.cssText="display: none; position: absolute; background: #666; color: white; padding: 10px; border: 1px dashed #999; font-family: sans-serif; font-size: 12px; height: 20px; line-height: 20px; z-index: 1000;";document.body.appendChild(tooltip);
...
c.getLatLngs();jscallback.updateRoute("editable:vertex:new",b,coordsToString(a))});c.on("editable:vertex:mouseover",function(a){a=a.latlng;jscallback.registerRoute(b,a.lat,a.lng);c.openTooltip(a)});c.on("editable:vertex:mouseout",function(a){a=a.latlng;jscallback.deregisterRoute(b,a.lat,a.lng);c.closeTooltip()});c.on("mouseover",function(a){a=a.latlng;jscallback.registerRoute(b,a.lat,a.lng)});c.on("mouseout",function(a){a=a.latlng;jscallback.deregisterRoute(b,a.lat,a.lng)})};
