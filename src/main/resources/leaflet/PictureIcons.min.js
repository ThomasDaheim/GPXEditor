...
title:"Show Picture Icons",onClick:function(a,b){jscallback.togglePictureIcons(!0);a.state("hide-picture-icons")}},{stateName:"hide-picture-icons",icon:'<span class="cross">&cross;</span>',title:"Hide Picture Icons",onClick:function(a,b){jscallback.togglePictureIcons(!1);a.state("show-picture-icons")}}]});togglePictureIconsButton.addTo(myMap);
function setPictureIconsButtonState(a){"ON"==a.toUpperCase()?togglePictureIconsButton.state("hide-picture-icons"):"OFF"==a.toUpperCase()&&togglePictureIconsButton.state("show-picture-icons")};