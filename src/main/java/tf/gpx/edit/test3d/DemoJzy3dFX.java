    ...
    private AWTChart getDemoChart(JavaFXChartFactory factory, String toolkit) {
        ...
        Mapper mapper = new Mapper() {
            ...
            public double f(double x, double y) {
                return Math.max(0, SRTMDataStore.getInstance().getValueForCoordinate(45d + x, 10d + y));
            }
        };
        
        SRTMDataStore.getInstance().setStorePath("D:\\Gemeinsame Dokumente\\Freizeit\\Training\\SRTM");

        // Define range and precision for the function to plot
        Range range = new Range(1f/1200f, 1f - 1f/1200f);
        int steps = 120;
