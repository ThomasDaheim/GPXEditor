...
public class GPXEditorParameters {
    ...
    private EarthGeometry.ReductionAlgorithm reduceAlgorithm;
            ...
            if (command.hasOption(GPXEditorParameters.CmdOps.reduceAlgorithm.toString())) {
                ...
                switch (value) {
                    case "DouglasPeucker":
                        ...
                        reduceAlgorithm = EarthGeometry.ReductionAlgorithm.DouglasPeucker;
                        break;
                    case "ReumannWitkam":
                        // System.out.println("Option reduceAlgorithm found: " + value);
                        reduceAlgorithm = EarthGeometry.ReductionAlgorithm.ReumannWitkam;
                        break;
                    default:
    ...
    public EarthGeometry.ReductionAlgorithm getReduceAlgorithm() {
